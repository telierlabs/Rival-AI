...
export class GeminiService {
  /**
   * Mengambil API Key dari environment variable sesuai foto Vercel (API_KEY_1, API_KEY_2, API_KEY_3).
   */
  private getRotatedAI(): GoogleGenAI {
    ...
    if (keys.length === 0) {
      throw new Error("API Key tidak ditemukan! Pastikan di Vercel sudah benar.");
    }
